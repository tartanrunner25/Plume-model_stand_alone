...
plume_ID = 'Creek_fire_09062020-00z'            #Name of simulation, which is used to name model output. Should a string.
...
entrain   = 0.05                                #The entrainment coefficient. Generally leave this as .05.
...
create_image = False                            #Do we want to create a plot?
...
thermo_file = './input_data/sounding_REV_09-06-2020_0z.txt'
...
if(create_image ==True):
    ...
    #Set axis labels
    ax.set_xlabel('Detrain (unitless)', fontsize=14)
